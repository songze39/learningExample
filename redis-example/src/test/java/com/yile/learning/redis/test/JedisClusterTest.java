...
import com.yile.learning.redis.utils.ClientKillerUtil;
import com.yile.learning.redis.utils.HostAndPortUtil;
import com.yile.learning.redis.utils.JedisClusterTestUtil;
...
public class JedisClusterTest extends Assert {
	...
	public void testDiscoverNodesAutomatically() {
		...
		// JedisCluster jc2 = new JedisCluster(new HostAndPort("127.0.0.1",
		// 7379));
