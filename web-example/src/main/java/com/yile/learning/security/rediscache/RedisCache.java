...
public class RedisCache<K, V> implements Cache<K, V> {
	...
	/**
	 * Constructs a rediscache instance with the specified Redis manager and
	 * using a custom key prefix.
	 *
	 * @param cache
	 *            The rediscache manager instance
	 * @param prefix
